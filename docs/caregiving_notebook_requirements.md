...
관련 모델·데이터 검증 문서는 [`slm_rag_validation_plan.md`](./slm_rag_validation_plan.md)와 [`model_and_rag_data_catalog.md`](./model_and_rag_data_catalog.md)를 참조한다. 이 문서가 두 문서보다 우선하는 제품 요구사항 원본이다.
